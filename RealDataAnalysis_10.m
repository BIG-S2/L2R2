...
MCMCpara.nBurnin = 2e0; % number of burn-in samples
MCMCpara.nCollect = 2e0; % number of samples after burn-in

%% Hyperparameters for parameters in the mean structure
MeanStructHyperpar.a0 = 1e-3; % 1st gamma hyperparameter of tau_delta
MeanStructHyperpar.b0 = 1e-3; % 2nd gamma hyperparameter of tau_delta
MeanStructHyperpar.c0 = 0.1; % 1st gamma hyperparameter of tau_gamma
MeanStructHyperpar.d0 = 0.1; % 2nd gamma hyperparameter of tau_gamma
MeanStructHyperpar.e0 = 0.2; % 1st gamma hyperparameter of tau_b
MeanStructHyperpar.f0 = 0.2; % 2nd gamma hyperparameter of tau_b
...
FactorModelHyperpar.a2=2.1;   % the rate hyperparameter of the gamma prior for global shrinkage parameter
FactorModelHyperpar.as=1;   % the shape hyperparameter of the gamma prior for the precision of error
FactorModelHyperpar.bs=0.3;   % the rate hyperparameter of the gamma prior for the precision of error
...
MeanStructPar.U = zeros(p,r); % low-rank component
MeanStructPar.V = zeros(d,r); % low-rank component
MeanStructPar.Delta = ones(r,1); % low-rank component
MeanStructPar.G = zeros(q,d); % polynomial and spline coefficients
MeanStructPar.b = zeros(n, d); % random effect coefficients
...
% Flags
Flags.OrthogonalZ = true; % Are the columes of Z orthogonal, Z is the covariate matrix of random effects
